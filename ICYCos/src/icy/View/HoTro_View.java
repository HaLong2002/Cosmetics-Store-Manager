 ...
 * @author HP
 */
public class HoTro_View extends javax.swing.JFrame {
    public static HoTro_View HT=new HoTro_View();
    public HoTro_View() {
        initComponents();
        try{
...
public boolean checkQuyenQLGD() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HoTro_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
