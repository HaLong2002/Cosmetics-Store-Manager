 ...
 * @author HP
 */
public class ThamSoChung_View extends javax.swing.JFrame {

    public static ThamSoChung_View TS = new ThamSoChung_View();
    ThamSoChung_Controller bus = new ThamSoChung_Controller();
    ...
    public void DocTS() {
        ...
        for (ThamSoChung_DTO ts : ThamSoChung_Controller.dsts) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThamSoChung_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
