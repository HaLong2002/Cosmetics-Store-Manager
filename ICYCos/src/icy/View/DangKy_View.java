 ...
 */
public class DangKy_View extends javax.swing.JFrame {
public static DangKy_View DK =new DangKy_View();
 ...
 DefaultTableModel model=new DefaultTableModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangKy_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               DK.setVisible(true);
            //   new DangKy_View().setVisible(true);
            }
        });
    }
