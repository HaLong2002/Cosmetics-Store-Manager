...
import icy.Controller.LoaiSP_Controller;
...
public class SanPham_View extends javax.swing.JFrame {
    ...
    public static SanPham_View SP=new SanPham_View();
    TrangChu_ICY tc=new TrangChu_ICY();
    SanPham_Controller bus=new SanPham_Controller();
    SanPham_DTO sp=new SanPham_DTO();
    DefaultTableModel modelLoai=new DefaultTableModel();
    LoaiSP_Controller busLoai=new LoaiSP_Controller();
    ...
    public void DocDuLieu(){
        ...
        for (SanPham_DTO sp : SanPham_Controller.dssp) {
            //nạp dữ liệu cho mỗi row
            Vector row = new Vector();
            row.add(sp.MaSP);
            row.add(sp.TenSP);
            if (LoaiSP_Controller.dslsp == null) {
                busLoai.DocLSP();
            }
            for(LoaiSP_DTO lsp : LoaiSP_Controller.dslsp){
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1255, 740));
                ...
                .addGroup(panelSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelSanPhamLayout.createSequentialGroup()
                        ...
                        .addGroup(panelSanPhamLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(panelSanPhamLayout.createSequentialGroup()
                                .addComponent(txtSoDonVi, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (i == -1) {
            ...
            if (x == JOptionPane.YES_OPTION) {
                if (i >= 0) {
                    bus.xoa(ma);
                    SanPham_Controller.dssp.remove(i);
                    model.removeRow(i);
                    tblSanPham.setModel(model);
    ...
    private void btnSuaLoaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaLoaiActionPerformed
        ...
        if (tblLoaiSP.getSelectedRow() >= 0) {
            ...
            for (int i = 0; i < SanPham_Controller.dssp.size(); i++) {
...
//-----------------------Liên kết các chức năng----------------//
    ...
    private void btnDangXuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangXuatActionPerformed
        ...
        int output = JOptionPane.showConfirmDialog(SP, 
